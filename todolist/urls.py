...
# Custom admin site with essential security
...
urlpatterns = [
    ...
    # Admin site with authentication
    path('admin/login/', custom_admin.login, name='admin_login'),
    path('admin/logout/', custom_admin.logout, name='admin_logout'),
